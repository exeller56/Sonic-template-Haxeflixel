...
::Std_obj::__register();
::StartEmulationState_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_sonic_2_title_card_font_ttf_obj::__register();
::__ASSET__assets_fonts_sonic_2_title_card_font_ttf_obj::__register();
