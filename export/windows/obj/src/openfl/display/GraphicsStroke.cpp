...
HX_DEFINE_STACK_FRAME(_hx_pos_55614d7317440053_218_new,"openfl.display.GraphicsStroke","new",0x5684f03f,"openfl.display.GraphicsStroke.new","openfl/display/GraphicsStroke.hx",218,0x5e4870cf)
namespace openfl{
namespace display{
...
void GraphicsStroke_obj::__construct( ::Dynamic thickness,::hx::Null< bool >  __o_pixelHinting, ::Dynamic __o_scaleMode, ::Dynamic __o_caps, ::Dynamic __o_joints,::hx::Null< Float >  __o_miterLimit,::Dynamic fill){
            	...
            	HX_STACKFRAME(&_hx_pos_55614d7317440053_218_new)
HXLINE( 219)		if (::hx::IsNull( thickness )) {
HXLINE( 219)			thickness = ::Math_obj::NaN;
            		}
HXLINE( 221)		this->caps = caps;
HXLINE( 222)		this->fill = fill;
HXLINE( 223)		this->joints = joints;
HXLINE( 224)		this->miterLimit = miterLimit;
HXLINE( 225)		this->pixelHinting = pixelHinting;
HXLINE( 226)		this->scaleMode = scaleMode;
HXLINE( 227)		this->thickness = ( (Float)(thickness) );
HXLINE( 228)		this->_hx___graphicsDataType = 0;
            	}
