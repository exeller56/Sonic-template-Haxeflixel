...
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_253_getRGBA,"openfl.display._internal.CanvasGraphics","getRGBA",0xcee2b69b,"openfl.display._internal.CanvasGraphics.getRGBA","openfl/display/_internal/CanvasGraphics.hx",253,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_262_getDimensions,"openfl.display._internal.CanvasGraphics","getDimensions",0x00dbc794,"openfl.display._internal.CanvasGraphics.getDimensions","openfl/display/_internal/CanvasGraphics.hx",262,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_280_createTempPatternCanvas,"openfl.display._internal.CanvasGraphics","createTempPatternCanvas",0x6ada6549,"openfl.display._internal.CanvasGraphics.createTempPatternCanvas","openfl/display/_internal/CanvasGraphics.hx",280,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_304_drawRoundRect,"openfl.display._internal.CanvasGraphics","drawRoundRect",0xaa7470ff,"openfl.display._internal.CanvasGraphics.drawRoundRect","openfl/display/_internal/CanvasGraphics.hx",304,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_338_endFill,"openfl.display._internal.CanvasGraphics","endFill",0xd6b0224f,"openfl.display._internal.CanvasGraphics.endFill","openfl/display/_internal/CanvasGraphics.hx",338,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_347_endStroke,"openfl.display._internal.CanvasGraphics","endStroke",0x88be9284,"openfl.display._internal.CanvasGraphics.endStroke","openfl/display/_internal/CanvasGraphics.hx",347,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_578_hitTest,"openfl.display._internal.CanvasGraphics","hitTest",0x934efa96,"openfl.display._internal.CanvasGraphics.hitTest","openfl/display/_internal/CanvasGraphics.hx",578,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_583_isCCW,"openfl.display._internal.CanvasGraphics","isCCW",0x9437381e,"openfl.display._internal.CanvasGraphics.isCCW","openfl/display/_internal/CanvasGraphics.hx",583,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_587_normalizeUVT,"openfl.display._internal.CanvasGraphics","normalizeUVT",0xa0796975,"openfl.display._internal.CanvasGraphics.normalizeUVT","openfl/display/_internal/CanvasGraphics.hx",587,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_628_playCommands,"openfl.display._internal.CanvasGraphics","playCommands",0xa3390eeb,"openfl.display._internal.CanvasGraphics.playCommands","openfl/display/_internal/CanvasGraphics.hx",628,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1286_render,"openfl.display._internal.CanvasGraphics","render",0xc2394625,"openfl.display._internal.CanvasGraphics.render","openfl/display/_internal/CanvasGraphics.hx",1286,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1612_renderMask,"openfl.display._internal.CanvasGraphics","renderMask",0x605729b1,"openfl.display._internal.CanvasGraphics.renderMask","openfl/display/_internal/CanvasGraphics.hx",1612,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1726_setSmoothing,"openfl.display._internal.CanvasGraphics","setSmoothing",0x137bf581,"openfl.display._internal.CanvasGraphics.setSmoothing","openfl/display/_internal/CanvasGraphics.hx",1726,0x5a71bf7c)
...
::String CanvasGraphics_obj::getRGBA(int color,Float alpha){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_253_getRGBA)
HXLINE( 254)		int r = ::hx::UShr((color & 16711680),16);
HXLINE( 255)		int g = ::hx::UShr((color & 65280),8);
HXLINE( 256)		int b = (color & 255);
HXLINE( 258)		int _hx_int = r;
HXDLIN( 258)		Float _hx_tmp;
HXDLIN( 258)		if ((_hx_int < 0)) {
HXLINE( 258)			_hx_tmp = (((Float)4294967296.0) + _hx_int);
            		}
            		else {
HXLINE( 258)			_hx_tmp = (_hx_int + ((Float)0.0));
            		}
HXDLIN( 258)		::String _hx_tmp1 = ((HX_("rgba(",f4,cc,0d,e8) + ::Std_obj::string(_hx_tmp)) + HX_(", ",74,26,00,00));
HXDLIN( 258)		int int1 = g;
HXDLIN( 258)		Float _hx_tmp2;
HXDLIN( 258)		if ((int1 < 0)) {
HXLINE( 258)			_hx_tmp2 = (((Float)4294967296.0) + int1);
            		}
            		else {
HXLINE( 258)			_hx_tmp2 = (int1 + ((Float)0.0));
            		}
HXDLIN( 258)		::String _hx_tmp3 = ((_hx_tmp1 + ::Std_obj::string(_hx_tmp2)) + HX_(", ",74,26,00,00));
HXDLIN( 258)		int int2 = b;
HXDLIN( 258)		Float _hx_tmp4;
HXDLIN( 258)		if ((int2 < 0)) {
HXLINE( 258)			_hx_tmp4 = (((Float)4294967296.0) + int2);
            		}
            		else {
HXLINE( 258)			_hx_tmp4 = (int2 + ((Float)0.0));
            		}
HXDLIN( 258)		return ((((_hx_tmp3 + ::Std_obj::string(_hx_tmp4)) + HX_(", ",74,26,00,00)) + alpha) + HX_(")",29,00,00,00));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(CanvasGraphics_obj,getRGBA,return )
 ...
 ::Dynamic CanvasGraphics_obj::getDimensions( ::openfl::geom::Matrix matrix){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_262_getDimensions)
HXLINE( 263)		Float angle = ::Math_obj::atan2(matrix->c,matrix->a);
HXLINE( 264)		Float cos = ::Math_obj::cos(angle);
HXLINE( 266)		Float w = ((matrix->a / cos) * ((Float)1638.4));
HXLINE( 267)		Float h = ((matrix->d / cos) * ((Float)1638.4));
HXLINE( 269)		bool _hx_tmp;
HXDLIN( 269)		if ((w == 0)) {
HXLINE( 269)			_hx_tmp = (h == 0);
            		}
            		else {
HXLINE( 269)			_hx_tmp = false;
            		}
HXDLIN( 269)		if (_hx_tmp) {
HXLINE( 271)			h = ((Float)819.2);
HXDLIN( 271)			w = h;
            		}
...
void CanvasGraphics_obj::createTempPatternCanvas( ::openfl::display::BitmapData bitmap,bool repeat,int width,int height){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_280_createTempPatternCanvas)
            	}
...
void CanvasGraphics_obj::drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_304_drawRoundRect)
            	}
...
void CanvasGraphics_obj::endFill(){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_338_endFill)
            	}
...
void CanvasGraphics_obj::endStroke(){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_347_endStroke)
            	}
...
bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_578_hitTest)
...
bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_583_isCCW)
HXDLIN( 583)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < 0);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(CanvasGraphics_obj,isCCW,return )
 ...
 ::Dynamic CanvasGraphics_obj::normalizeUVT( ::openfl::_Vector::FloatVector uvt,::hx::Null< bool >  __o_skipT){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_587_normalizeUVT)
HXLINE( 588)		Float max = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 589)		Float tmp = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 590)		int len = uvt->get_length();
HXLINE( 592)		{
HXLINE( 592)			int _g = 1;
HXDLIN( 592)			int _g1 = (len + 1);
HXDLIN( 592)			while((_g < _g1)){
HXLINE( 592)				_g = (_g + 1);
HXDLIN( 592)				int t = (_g - 1);
HXLINE( 594)				bool _hx_tmp;
HXDLIN( 594)				if (skipT) {
HXLINE( 594)					_hx_tmp = (::hx::Mod(t,3) == 0);
            				}
            				else {
...
HXLINE( 599)				tmp = uvt->get((t - 1));
HXLINE( 601)				if ((max < tmp)) {
HXLINE( 603)					max = tmp;
            				}
            			}
            		}
HXLINE( 607)		if (!(skipT)) {
HXLINE( 609)			return  ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("max",a4,0a,53,00),max)
            				->setFixed(1,HX_("uvt",f3,2e,59,00),uvt));
            		}
HXLINE( 612)		int length = null();
HXDLIN( 612)		bool fixed = null();
HXDLIN( 612)		::Array< Float > array = null();
HXDLIN( 612)		 ::openfl::_Vector::FloatVector result =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true);
HXLINE( 614)		{
HXLINE( 614)			int _g2 = 1;
HXDLIN( 614)			int _g3 = (len + 1);
HXDLIN( 614)			while((_g2 < _g3)){
HXLINE( 614)				_g2 = (_g2 + 1);
HXDLIN( 614)				int t1 = (_g2 - 1);
HXLINE( 616)				bool _hx_tmp1;
HXDLIN( 616)				if (skipT) {
HXLINE( 616)					_hx_tmp1 = (::hx::Mod(t1,3) == 0);
            				}
            				else {
...
HXLINE( 621)				result->push(uvt->get((t1 - 1)));
            			}
            		}
HXLINE( 624)		return  ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("max",a4,0a,53,00),max)
...
void CanvasGraphics_obj::playCommands( ::openfl::display::_internal::DrawCommandBuffer commands,::hx::Null< bool >  __o_stroke){
            	...
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_628_playCommands)
            	}
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1286_render)
            	}
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1612_renderMask)
            	}
...
void CanvasGraphics_obj::setSmoothing(bool smooth){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1726_setSmoothing)
            	}
