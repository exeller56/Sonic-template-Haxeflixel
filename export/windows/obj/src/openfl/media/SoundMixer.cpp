...
HXLINE( 176)			i = (i - 1);
HXLINE( 177)			::openfl::media::SoundMixer_obj::_hx___soundChannels->__get(i).StaticCast<  ::openfl::media::SoundChannel >()->stop();
            		}
            	}
...
HXLINE( 203)			i = (i - 1);
HXLINE( 204)			 ::openfl::media::SoundChannel channel = ::openfl::media::SoundMixer_obj::_hx___soundChannels->__get(i).StaticCast<  ::openfl::media::SoundChannel >();
HXLINE( 205)			if (::hx::IsInstanceEq( channel->_hx___audioSource->buffer,buffer )) {
HXLINE( 207)				channel->stop();
            			}
            		}
            	}
