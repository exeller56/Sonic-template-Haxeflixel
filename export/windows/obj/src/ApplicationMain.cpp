...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Sonic the hedgehog",9e,2d,41,03),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("creepy barrel",ee,7b,7e,cf));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Sonic the hedgehog",9e,2d,41,03));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Sonic the hedgehog",9e,2d,41,03));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),1920)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),1080)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Sonic the hedgehog",9e,2d,41,03))
            			->setFixed(10,HX_("alwaysOnTop",67,4d,53,16),false)
            			->setFixed(11,HX_("borderless",45,46,71,17),true)
