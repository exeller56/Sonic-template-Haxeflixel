...
HX_LOCAL_STACK_FRAME(_hx_pos_8ecece8ce262ecb9_29_getWindowsbackward,"FlxTransWindow","getWindowsbackward",0x83c70dd8,"FlxTransWindow.getWindowsbackward","FlxTransWindow.hx",29,0x80000378)
#include <windows.h>
#include <dwmapi.h>
...
int FlxTransWindow_obj::getWindowsbackward(::hx::Null< int >  __o_res){
            		int res = __o_res.Default(0);
            	HX_STACKFRAME(&_hx_pos_8ecece8ce262ecb9_29_getWindowsbackward)
...
HXDLIN(  29)		return res;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTransWindow_obj,getWindowsbackward,return )
