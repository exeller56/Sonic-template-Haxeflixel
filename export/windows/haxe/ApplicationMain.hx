...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Sonic the hedgehog", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Sonic the hedgehog", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "35";
		app.meta["company"] = "creepy barrel";
		app.meta["file"] = "Sonic the hedgehog";
		app.meta["name"] = "Sonic the hedgehog";
		...
		#elseif air
		app.window.title = "Sonic the hedgehog";
		#else
